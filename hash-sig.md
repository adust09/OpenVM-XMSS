...
- 具体的な XMSS インスタンスは `signature::generalized_xmss::instantiations_*` に型エイリアスとして定義（現在の OpenVM では `instantiations_poseidon::lifetime_2_to_the_18::winternitz::SIGWinternitzLifetime18W1` を採用）。
